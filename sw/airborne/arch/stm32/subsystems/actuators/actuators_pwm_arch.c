...
int32_t actuators_pwm_values_old[ACTUATORS_PWM_NB];
...
void actuators_pwm_commit(void) {
  ...
  timer_set_oc_value(TIM4, TIM_OC1, 0.9*actuators_pwm_values_old[6]+0.1*actuators_pwm_values[6]);
  timer_set_oc_value(TIM4, TIM_OC2, 0.9*actuators_pwm_values_old[7]+0.1*actuators_pwm_values[7]);
#endif
#if REMAP_SERVOS_5AND6
